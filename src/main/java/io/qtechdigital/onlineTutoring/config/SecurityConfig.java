package io.qtechdigital.onlineTutoring.config;

import io.qtechdigital.onlineTutoring.security.JwtUserDetailsService;
import io.qtechdigital.onlineTutoring.security.jwt.JwtConfigurer;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers(AUTH_ENDPOINT, SOCKET_ENDPOINT).permitAll()
